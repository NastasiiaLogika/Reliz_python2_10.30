...
background = transform.scale(image.load(
    "backgroundlvl3.png"), (win_width, win_height))


# Персонажі гри:
player = Player('sprite1.png', 600, win_height - 90, 5)
monster = Enemy('sprite4.png', win_width - 80, 280, 2)
...
w5 = Wall(154, 205, 50, 250, 50, 10, 300) 
w6 = Wall(154, 205, 50, 350, 180, 10, 300)
w7 = Wall(154, 205, 50, 450, 50, 10, 300)
w8 = Wall(154, 205, 50, 550, 180, 10, 300)
